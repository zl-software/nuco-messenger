...
const VARIANTS: Record<TextVariant, TextStyle> = {
  ...
  title: { fontFamily: Fonts.bold, fontSize: 20, lineHeight: 26, letterSpacing: -0.2, color: Colors.text },
  section: { fontFamily: Fonts.bold, fontSize: 19, lineHeight: 25, letterSpacing: -0.19, color: Colors.text },
  subtitle: { fontFamily: Fonts.semibold, fontSize: 17, lineHeight: 23, color: Colors.text },
  rowTitle: { fontFamily: Fonts.semibold, fontSize: 16, lineHeight: 22, color: Colors.text },
