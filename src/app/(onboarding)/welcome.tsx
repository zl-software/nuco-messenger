...
import { Button, NucoLockup, Screen, Text, VerifiedShield } from '@/ui';
    ...
    <Screen glow contentStyle={styles.content}>
      ...
      <View style={styles.footer}>
        ...
        <View style={styles.footnote}>
          <VerifiedShield size={16} color={Colors.textTertiary} />
          <Text variant="caption" color="textTertiary" style={styles.footnoteText}>
            {t('onboarding.welcomeFootnote')}
          </Text>
        </View>
      </View>
    </Screen>
...
const styles = StyleSheet.create({
  ...
  footnoteText: { flexShrink: 1, textAlign: 'center' },
});
